...
cands=[]
for s in np.arange(15.4,16.21,0.2):
    for l in (-.3,-.2,-.1,0):
        cands.append(('c',f"font-family:P6;font-size:{s:.2f}px;letter-spacing:{l}px",'AUDIENCES',('P6',s,l)))
for w in ('WS',):
    for s in np.arange(19,26.1,0.5):
