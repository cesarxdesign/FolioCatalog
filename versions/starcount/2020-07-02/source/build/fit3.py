...
for w in (200,250,300):
    for sz in np.arange(20.5,22.6,0.25):
        cands.append(('b',f"font-family:PV;font-weight:{w};font-size:{sz:.2f}px",'/',(w,sz)))
H=50
html='''<html><head><style>
@font-face{font-family:WS;src:url(../../site/fonts/bodoni72-book-starcount.woff2)}
@font-face{font-family:PV;src:url(../../site/fonts/plexsans-var-slash.woff2);font-weight:100 700}
